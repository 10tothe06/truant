...
// if you have beef with this code then blame that codebase

// I didn't write it though so don't beef with me

// this script name is a bit long tbh
public class medit_utils_objexporter : MonoBehaviour
{
